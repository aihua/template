...
\usepackage[bookmarksnumbered,pdfborder=1,breaklinks,colorlinks,linkcolor=RoyalBlue3,urlcolor=blue]{hyperref}
\usepackage{makeidx}
...
\setCJKmonofont{Droid Sans Mono}
...
\titleformat{\chapter}[block]{\hei\center\Huge\bfseries}{\chaptername}{1em}{}
...
%\include{chapter/chapter-003}
%\include{chapter/chapter-004}
